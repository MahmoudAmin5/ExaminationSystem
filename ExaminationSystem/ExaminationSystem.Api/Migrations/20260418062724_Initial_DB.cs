    ...
    public partial class Initial_DB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttemptQuestionOrders", x => new { x.AttemptId, x.QuestionId });
                    table.ForeignKey(
                        name: "FK_AttemptQuestionOrders_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AttemptQuestionOrders_QuizAttempts_AttemptId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttemptOptionOrders", x => new { x.AttemptId, x.OptionId });
                    table.ForeignKey(
                        name: "FK_AttemptOptionOrders_AnswerOptions_OptionId",
                        column: x => x.OptionId,
                        principalTable: "AnswerOptions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AttemptOptionOrders_QuizAttempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "QuizAttempts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttemptOptionOrders_OptionId",
                table: "AttemptOptionOrders",
                column: "OptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AttemptQuestionOrders_QuestionId",
                table: "AttemptQuestionOrders",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_StudentId_StartedAt",
                table: "QuizAttempts",
